export const nav = `<nav class="navbar navbar-expand-lg navbar-light fixed-top">
   <a class="navbar-brand" href="/pages#"> <img src="/images/cropped-mein_freund_mykola.png" alt="Mykola" width="30px"></a>
      ...
      <ul class="navbar-nav mr-auto sidenav" id="navAccordion">
         <li class="nav-item active">
            <div class="main-page-link">
               ...
               <a class="nav-link " href="/index.html">  Головна - Principal  </a>
            </div>
         </li>
         <li class="nav-item">
            <a class="nav-link nav-link-collapse" href="/pages/moldova.html" id="hasSubItems" data-toggle="collapse"
               data-target="#collapseSubItems2" aria-controls="collapseSubItems2" aria-expanded="false">Мапа - Hartă</a>
            <ul class="nav-second-level collapse" id="collapseSubItems2" data-parent="#navAccordion">
               <li class="nav-item">
                  <a class="nav-link" href="/pages/moldova.html">
                     <span class="nav-link-text">Про Молдову - Despre Moldova</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="/pages/nord.html">
                     <span class="nav-link-text">Північ – Nord</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="/pages/vest.html">
                     <span class="nav-link-text">Захід – Vest</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="/pages/est.html">
                     <span class="nav-link-text">Схід – Est</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="/pages/sud.html">
         ...
         <li class="nav-item">
            ...
            <ul class="nav-second-level collapse" id="collapseSubItems4" data-parent="#navAccordion">
               ...
               <li class="nav-item">
                  <a class="nav-link" href="/pages/vidpochinok.html">
                     <span class="nav-link-text">Вільний час - timp liber</span>
                  </a>
               </li>
               
               <li class="nav-item">
                  <a class="nav-link" href="/pages/cumparaturi.html">
                     <span class="nav-link-text">Покупки – Cumpărături</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="/pages/scoala.html">
                     <span class="nav-link-text">Школа – Şcoală</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="/pages/alimente.html">
                     <span class="nav-link-text">Їжа – Alimente</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="/pages/sanatate.html">
         ...
         <li class="nav-item">
            <a class="nav-link nav-link-collapse" href="/pages/ajutor.html" id="hasSubItems" data-toggle="collapse"
         ...
         <li class="nav-item active">
            <a class="nav-link" href="/pages/asistenti.html">Помічники Миколи – Asistenții lui Mykola</a>
         </li>
      </ul>
   </div>
</nav>`